...
.pull-left[
<br><br><br><br><br>
_Amo gráficos como amo cavalos. Gosto de música ruim e de cinema (bom). Sou apaixonada pelo Botafogo e pelo Bayern de Munique. Prefiro Vila Velha a qualquer lugar no mundo. Não tenho sonhos, mas um dia espero ver a Palestina livre._
]
...
```{r echo=FALSE, fig.align ='center', out.width="85%", fig.cap='Figura 5: Arte com R por Danielle Navarro (à esquerda) e Thomas Lin Pedersen (à direita).'}
